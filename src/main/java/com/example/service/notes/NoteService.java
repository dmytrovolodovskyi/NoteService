...
import com.example.service.notes.dto.create.CreateNoteRequest;
import com.example.service.notes.dto.create.CreateNoteResponse;
import com.example.service.notes.dto.delete.DeleteNoteResponse;
import com.example.service.notes.dto.get.GetUserNotesResponse;
import com.example.service.notes.dto.update.UpdateNoteRequest;
import com.example.service.notes.dto.update.UpdateNoteResponse;
...
public class NoteService {
    ...
    public UpdateNoteResponse update(String username, UpdateNoteRequest request) {
        Optional<Note> optionalNote = repository.findById(String.valueOf(request.getId()));
